...
> Generated: 2026-02-05T18:24:39.698Z
...
flowchart TD
  ...
  D9{"Is Karaoke supported for this song?"}
  D10{"Is microphone permission granted?"}
  D11{"Is microphone permission granted?"}
  D12{"How does host invite friends?"}
  D13{"Are participants ready?"}
  D14{"Is invite link valid?"}
  D15{"Is microphone permission granted?"}
  D16{"Has host started the session?"}
